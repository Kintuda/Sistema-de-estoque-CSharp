...
namespace enzo_estoque.Controllers
{
    public class ProdutoVendasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Valor,Quantidade")] ProdutoVenda produtoVenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Valor,Quantidade")] ProdutoVenda produtoVenda)
        {
            if (ModelState.IsValid)
            {
